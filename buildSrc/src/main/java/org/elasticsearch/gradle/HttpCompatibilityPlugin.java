...
public class HttpCompatibilityPlugin implements Plugin<Project> {

    private final String SOURCE_SET_NAME = "compat";
    ...
    public void apply(Project project) {
        ...
        SourceSet compatSourceSet = sourceSets.create(SOURCE_SET_NAME);


        // setup IDEs
        String runtimeClasspathName = compatSourceSet.getRuntimeClasspathConfigurationName();
        ...
        project.getPluginManager().withPlugin("idea", p -> {
            ...
            idea.getModule().setTestSourceDirs(compatSourceSet.getJava().getSrcDirs());
