...
public class QueryRescorerIT extends ESIntegTestCase {
    ...
    public void testMultipleRescores() throws Exception {
        ...
        // Now squash the second rescore window so it never gets to see a main
        ...
        // We have no idea what the second hit will be because we didn't get a chance to look for main
