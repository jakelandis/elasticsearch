...
public class RestMultiSearchActionV7Tests extends RestActionTestCase {

    @Before
    public void setUpAction() {
        controller().registerHandler(new RestMultiSearchActionV7(Settings.EMPTY));
    }
    ...
    public void testTypeInPath() {
        ...
        assertWarnings(RestMultiSearchActionV7.TYPES_DEPRECATION_MESSAGE);
    }
