...
public class RepositoryURLRestCompatYamlTestSuiteIT extends AbstractRestCompatYamlTestSuite {

    public RepositoryURLRestCompatYamlTestSuiteIT(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }
