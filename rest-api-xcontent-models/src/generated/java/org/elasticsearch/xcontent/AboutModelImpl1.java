...
public final class AboutModelImpl1 implements ToXContentObject {
  @SuppressWarnings({"unchecked"})
  public static final ConstructingObjectParser<AboutModelImpl1, Void> PARSER = new ConstructingObjectParser<>(AboutModelImpl1.class.getName(), a -> new AboutModelImpl1(
  (String) a[0],
  (String) a[1],
  (String) a[2],
  (String) a[3],
  ...
  static {
    ...
    PARSER.declareString(ConstructingObjectParser.constructorArg(), new ParseField("version"));
  ...
  public AboutModelImpl1(String name, String cluster_name, String cluster_uuid, String version,
      String build_flavor, String build_type, String build_hash, String build_date,
      Boolean build_snapshot, String lucene_version, String minimum_wire_compatibility_version,
      String minimum_index_compatibility_version, String tagline) {
    this.name = name;
