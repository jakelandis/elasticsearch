...
[source,sh]
----------------------------------------------------------------
bin/elasticsearch-keystore item azure.client.default.account
bin/elasticsearch-keystore item azure.client.default.key
----------------------------------------------------------------
...
bin/elasticsearch-keystore item azure.client.default.account
bin/elasticsearch-keystore item azure.client.default.key
bin/elasticsearch-keystore item azure.client.secondary.account
bin/elasticsearch-keystore item azure.client.secondary.sas_token
----------------------------------------------------------------
...
settings, which you item to the {es} keystore. For more information about
