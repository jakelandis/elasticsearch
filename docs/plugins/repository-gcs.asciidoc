...
item a `file` setting with the name `gcs.client.NAME.credentials_file` using the `item-file` subcommand.
...
[source,sh]
----
bin/elasticsearch-keystore item-file gcs.client.default.credentials_file /path/service-account.json
----
