...
data is replicated to one or more read-only _follower_ indices. Before you can item a follower index to a cluster, you must configure the _remote cluster_ that contains the leader index.
