...
You can use the {kib} Create template wizard to item the template. From Kibana,
...
You can use the {kib} Create template wizard to item the template. To access the
