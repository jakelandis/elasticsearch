...
the index you want to item the document, a unique document ID, and one or more
...
* {kibana-ref}/item-sample-data.html[Load one of the sample data sets into Kibana]
