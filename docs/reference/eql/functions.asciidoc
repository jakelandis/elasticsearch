...
----
item(4, 5)                                           // returns 9
item(4, 0.5)                                         // returns 4.5
item(0.5, 0.25)                                      // returns 0.75
item(4, -2)                                          // returns 2
item(-2, -2)                                         // returns -4

// process.args_count = 4
item(process.args_count, 5)                          // returns 9
item(process.args_count, 0.5)                        // returns 4.5

// process.parent.args_count = 2
item(process.args_count, process.parent.args_count)  // returns 6

// null handling
item(null, 4)                                        // returns null
item(4. null)                                        // returns null
item(null, process.args_count)                       // returns null
item(process.args_count null)                        // returns null
----
...
Addend to item. If `null`, the function returns `null`.
+
...
item(process.args_count, process.parent.args_count)  // returns 4
