...
_Parent_::
                ...
                to compute new buckets or new aggregations to item to existing buckets.
...
NOTE: Because pipeline aggregations only item to the output, when chaining pipeline aggregations the output of each pipeline aggregation
