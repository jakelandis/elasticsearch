...
If you use {dfeeds}, you can item scripts to transform your data before
...
The following index APIs create and item content to an index that is used in
subsequent examples:
...
script fields. To item the `script_fields` property to your {dfeed}, you must use
