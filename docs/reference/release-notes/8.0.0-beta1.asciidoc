...
Machine Learning::
* Removing allow_no_[datafeeds|jobs] from v8 APIs {es-pull}80048[#80048] (issue: {es-issue}60732[#60732])
...
* Adding two missing entries to the deprecation info api {es-pull}80290[#80290] (issue: {es-issue}80233[#80233])

Infra/Scripting::
* Add nio Buffers to Painless {es-pull}79870[#79870] (issue: {es-issue}79867[#79867])
* Script: Restore the scripting general cache {es-pull}79453[#79453] (issue: {es-issue}62899[#62899])
...
* Upgrade repository-hdfs to Hadoop 3 {es-pull}76897[#76897]
...
Infra/Core::
* Prevent stack overflow in rounding [OPEN] {es-pull}80450[#80450]
...
* Fixing `MlMetadata` backwards compatibility bug with 7.13-16 {es-pull}80041[#80041]
