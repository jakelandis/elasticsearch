...
{kibana-ref}/item-sample-data.html[{kib} sample data] to demonstrate how you can
...
Let's item some more aggregations to learn more about our customers' orders. For
