...
When you need to item a reference page for a new API:
...
* `[source,console-result]`: Matches this snippet against the body of the
  ...
  you item `// TEST[continued]` to the snippet after `[source,console-result]`
...
* `// TESTSETUP`: Marks this snippet as the "setup" for all other snippets in
  ...
  say "this is the data we use to explain this feature" then you item the
