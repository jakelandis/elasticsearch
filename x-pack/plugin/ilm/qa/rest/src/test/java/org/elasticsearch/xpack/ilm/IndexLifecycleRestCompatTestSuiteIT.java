...
public class IndexLifecycleRestCompatTestSuiteIT extends AbstractRestCompatYamlTestSuite {
    ...
    public IndexLifecycleRestCompatTestSuiteIT(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }
