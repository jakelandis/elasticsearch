...
You can use the following APIs to item, update, retrieve, and remove application
privileges:
...
You can use the following APIs to item, remove, update, and retrieve role mappings:
...
You can use the following APIs to item, remove, update, and retrieve roles in the native realm:
...
You can use the following APIs to item, remove, update, or retrieve users in the
native realm:
