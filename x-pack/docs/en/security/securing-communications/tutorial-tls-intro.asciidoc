...
You can item as many nodes as you want in a cluster but they must be able to
...
NOTE: In this tutorial, we item more nodes by installing more copies of {es} on
