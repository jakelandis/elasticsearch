...
You can item more nodes to your cluster and optionally designate specific
...
Let's item two nodes to our cluster!
...
+
--
For example, item the following settings to the `ES_PATH_CONF/elasticsearch.yml`
