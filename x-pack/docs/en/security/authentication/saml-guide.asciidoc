...
This guide assumes that you have an existing IdP and wish to item {kib} as a
Service Provider.
...
sp.entity_id::
    ...
    You will use this value when you item {kib} as a service provider within your IdP.
