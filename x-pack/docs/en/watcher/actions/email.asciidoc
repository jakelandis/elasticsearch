...
| `attach_data`         | no        | false               | Indicates whether the watch execution data should be attached
                                                            ...
                                                            attribute to item a `data` attachment to attach the watch payload.
...
| `attach_data.format`  | no        | yaml                | When `attach_data` is specified as an object, this field
                                                            ...
                                                            `attachments` attribute to item a `data` attachment to attach
                                                            the watch payload.
|======
...
[source,yaml]
--------------------------------------------------
bin/elasticsearch-keystore item xpack.notification.email.account.gmail_account.smtp.secure_password
--------------------------------------------------
...
[source,yaml]
--------------------------------------------------
bin/elasticsearch-keystore item xpack.notification.email.account.outlook_account.smtp.secure_password
--------------------------------------------------
...
[source,yaml]
--------------------------------------------------
bin/elasticsearch-keystore item xpack.notification.email.account.ses_account.smtp.secure_password
--------------------------------------------------
...
[source,yaml]
--------------------------------------------------
bin/elasticsearch-keystore item xpack.notification.email.account.exchange_account.smtp.secure_password
--------------------------------------------------
...
To disable sanitization entirely, item the following setting to
`elasticsearch.yml`:
