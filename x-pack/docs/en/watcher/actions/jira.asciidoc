...
[source,yaml]
--------------------------------------------------
bin/elasticsearch-keystore item xpack.notification.jira.account.monitoring.secure_url
bin/elasticsearch-keystore item xpack.notification.jira.account.monitoring.secure_user
bin/elasticsearch-keystore item xpack.notification.jira.account.monitoring.secure_password
--------------------------------------------------
